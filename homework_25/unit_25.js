...
let linkSite = new XMLHttpRequest();
let r = 1;
let keyItgid = "5ADcB96BA48d3f80";
let link = "http://getpost.itgid.info/index2.php";
let requestGet = "GET";
let requestPost = "POST";

function t1() {
  linkSite.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      openRequest(this.responseText);
    }
  };

  linkSite.open(requestGet, `${link}?auth=${keyItgid}&action=1`);
...
function t2() {
  ...
  linkSite.open(requestGet, `${link}?auth=${keyItgid}&action=2&name=Ivanio`);
...
function t3() {
  ...
  linkSite.open(requestGet, `${link}?auth=${keyItgid}&action=3&num1=1&num2=2`);
...
function t4() {
  ...
  linkSite.open(requestGet, `${link}?auth=${keyItgid}&action=4&num1=1&num2=9`);
...
function t5() {
  ...
  linkSite.open(requestGet, `${link}?auth=${keyItgid}&action=5`);
  function openRequest(data) {
...
function t6() {
  ...
  linkSite.open(requestGet, `${link}?auth=${keyItgid}&action=6&num1=4&num2=34`);
...
function t7() {
  ...
  linkSite.open(requestGet, `${link}?auth=${keyItgid}&action=7&`);
  function openRequest(data) {
...
function t8() {
  ...
  linkSite.open(requestGet, `${link}?auth=${keyItgid}&action=8&year=1989`);
  function openRequest(data) {
...
function t9() {
  ...
  linkSite.open(requestGet, `${link}?auth=${keyItgid}&action=9&m=1&d=1&y=1`);
  function openRequest(data) {
...
function t10() {
  ...
  linkSite.open(requestPost, link);
  linkSite.setRequestHeader(
    "Content-type",
    "application/x-www-form-urlencoded"
  );
  linkSite.send(`auth=${keyItgid}&action=1`);
...
function t11() {
  ...
  linkSite.send(`auth=${keyItgid}&action=2&name=Ivan`);
  function openRequest(data) {
...
function t12() {
  ...
  linkSite.send(`auth=${keyItgid}&action=3&num1=2&num2=5`);
  function openRequest(data) {
...
function t13() {
  ...
  linkSite.send(`auth=${keyItgid}&action=4&num1=1&num2=10`);
  function openRequest(data) {
...
function t14() {
  ...
  linkSite.send(`auth=${keyItgid}&action=5`);
  function openRequest(data) {
...
function t15() {
  ...
  linkSite.send(`auth=${keyItgid}&action=6&num1=2&num2=5`);
  function openRequest(data) {
...
function t16() {
  ...
  linkSite.send(`auth=${keyItgid}&action=7`);
  function openRequest(data) {
...
function t17() {
  ...
  linkSite.send(`auth=${keyItgid}&action=8&yaer=1989`);
  function openRequest(data) {
...
function t18() {
  ...
  linkSite.send(`auth=${keyItgid}&action=9&m=1&d=1&y=1`);
  function openRequest(data) {
