...
let goods = new Goods("No name", "Senteber", "img/1.png", 6);
goods.draw();
console.log(goods);
...
let goods3 = new Goods2("No name two", "Senteber", "img/2.png", 44, true);
goods3.draw();
console.log(goods3);
...
let valid = new Valid("email", "12345");
console.log(valid);
valid.validate();
...
let valid2 = new Valid("email", "1234567");
console.log(valid2);
valid2.validate();
...
let valid3 = new Valid2("", "1234567890");
console.log(valid3);
valid3.validate();
...
let valid4 = new Valid2("email", "1234567890");
console.log(valid4);
valid4.validate();
